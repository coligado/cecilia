...
(function() {
  var clearSearch, closeNameBox, displayResponse, images, nextImage, openNameBox, refreshWallpaper, searchName, selectedGender, simulateLoad;
  ...
  refreshWallpaper = function() {
    ...
    return $('body').css('backgroundImage', "url(assets/" + nextImage + ")");
  };
