...
(function() {
  var clearSearch, closeNameBox, displayResponse, images, openNameBox, refreshWallpaper, searchName, selectedGender, simulate_load;
  ...
  $(function() {
    refreshWallpaper();
    $(".shadow_box, .shadow_box_window").on("click", function(e) {
      var $currTarget;
    ...
    $('#first_name, #last_name').keydown(function(e) {
      if (e.keyCode === 13) {
        return $('#dai_button').click();
      }
    });
    return $('#dai_button').click(function() {
  ...
  refreshWallpaper = function() {
    return $('body').css('backgroundImage', "url(assets/" + images[Math.floor(Math.random() * images.length)] + ")");
  };

  searchName = function() {
    if ($(".shadow_box").hasClass("hide")) {
      openNameBox();
      return simulate_load = setTimeout(function() {
        $(".loading").hide();
        displayResponse();
      }, 3000);
    }
  ...
  clearSearch = function(invalidNumber) {
